...
public class Product {
    ...
    public Product(String pid, String pname, Double market_price, Double shop_price, String pimage, String pdate, Integer is_hot, String pdesc, Integer pflag, String cid) {
        this.pid = pid;
        this.pname = pname;
